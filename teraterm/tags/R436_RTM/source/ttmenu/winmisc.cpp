...
/* ==========================================================================
	...
	Outline			: 現時刻を表わす文字列を取得する。
	Arguments		: char		cTimeStr		(out)	現時刻を表わす文字列
	Return Value	: なし
	Reference		: 
	Renewal			: 
	Notes			: 
...
/* ==========================================================================
	...
	Outline			: 現時刻を表わす文字列を取得する。
	Arguments		: LPTSTR	lpszTimeStr		(out)	現時刻を表わす文字列
	Return Value	: なし
	Reference		: 
	Renewal			: 
	Notes			: 
...
void GetTimeEx(LPTSTR lpszTimeStr)
{
	...
	case 0:
		lstrcpy(cWeek, _T("日曜日"));
		break;
	case 1:
		lstrcpy(cWeek, _T("月曜日"));
		break;
	case 2:
		lstrcpy(cWeek, _T("火曜日"));
		break;
	case 3:
		lstrcpy(cWeek, _T("水曜日"));
		break;
	case 4:
		lstrcpy(cWeek, _T("木曜日"));
		break;
	case 5:
		lstrcpy(cWeek, _T("金曜日"));
		break;
	case 6:
		lstrcpy(cWeek, _T("土曜日"));
		break;
	}

	::wsprintf(lpszTimeStr, _T("西暦%u年 %u月%u日%s %u時%u分%u秒%u"),
							LocalTime.wYear,
							LocalTime.wMonth,
							LocalTime.wDay,
							cWeek,
