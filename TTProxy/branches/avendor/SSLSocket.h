                    ...
                    if (result == X509_V_OK) {
                        ...
                        if (id >= 0) {
	                        ...
	                        if (alt != NULL) {
								...
								int i; // VC++8Ç≈ÇÕäOÇ…èoÇ≥Ç»Ç¢Ç∆ÉGÉâÅ[Ç…Ç»ÇÈ (2006.8.1 yutaka)
	                            ...
	                            if (i < n)
	                                ...
	                                verify_result = IDS_UNMATCH_COMMON_NAME; /* common nameÇ™àÍívÇµÇ»Ç©Ç¡ÇΩ */
	                        }
                        }
                        if (!match && verify_result == 0) {
	                        ...
	                        if (X509_NAME_get_text_by_NID(xn, NID_commonName, buf, sizeof buf) == -1)
	                            verify_result = IDS_UNABLE_TO_GET_COMMON_NAME; /* common nameÇÃéÊìæÇ…é∏îsÇµÇΩ */
