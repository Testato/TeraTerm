...
[INI]
Filename: {app}\teraterm.ini; Section: TTXKanjiMenu; Key: ChangeBoth; String: off; Flags: createkeyifdoesntexist; Components: Additional_Plugins/TTXKanjiMenu
Filename: {userdocs}\teraterm.ini; Section: TTXKanjiMenu; Key: ChangeBoth; String: off; Flags: createkeyifdoesntexist; Check: isUserIniExists; Components: Additional_Plugins/TTXKanjiMenu
